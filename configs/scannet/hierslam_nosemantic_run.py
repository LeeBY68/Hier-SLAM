...
group_name = "ScanNet_no_semantic"
...
config = dict(
    ...
    wandb=dict(
        entity="username",
        project="hierslam_scannet_no_semantic",
        group=group_name,
        name=run_name,
        save_qual=False,
        eval_save_qual=True,
    ...
    data=dict(
        ...
        gradslam_data_cfg="./configs/data/scannet.yaml",    # no semantic 
        sequence=scene_name,
        ...
        stride=1,
        num_frames=-1,
        sem_mode="tree",        # "tree": 4-level tree, based on nyu40 / "tree_large": 5-level tree, based on original classes
        use_pyramid = False,
        pyramid_level = -1,                     
    ),
    tracking=dict(
